...
import { eraseCookie } from "@/helpers/cookies_handlers";
...
const Navbar = (props:any) => {
    ...
    const navigation = [
        { name: "Home", href: "/", current: props.current === 'home' },
        { name: "Companies", href: "/companies", current: props.current === 'companies' },
    ];
